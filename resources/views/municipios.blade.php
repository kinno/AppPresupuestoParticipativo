    ...
    <div class="card">
        <div class="card-body content-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <select name="municipios_id" id="municipios" class="form-control">
                        ...
                        <option value="{{ $municipio }}" title="{{ $municipio->id }}">{{  $municipio->descripcion}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row" style="display:none" id="descripcionMunicipio">
                ...
                <div class="col-12">
                    <center>
                        <a id="archivoMunicipio" target="_blank" class="card-link bi-file-earmark-pdf-fill text-center">Descargar archivo</a>
                    </center>
                </div>
            </div>
        </div>
